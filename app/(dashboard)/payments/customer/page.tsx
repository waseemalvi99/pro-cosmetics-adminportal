...
export default function CustomerPaymentPage() {
  ...
  const { register, handleSubmit, watch, setValue, formState: { errors } } = useForm<FormData>({
    ...
    defaultValues: { customerId: "", amount: 0, paymentMethod: "", chequeNumber: "", bankName: "", chequeDate: "", bankAccountReference: "", notes: "" },
  });
  ...
  const mutation = useMutation({
    mutationFn: (data: FormData) =>
      paymentsApi.createCustomerPayment({
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Record Customer Payment" description="Record a payment received from a customer" />
